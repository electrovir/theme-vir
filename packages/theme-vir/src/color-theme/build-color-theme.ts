...
/**
 * Extra contrast levels generated by {@link buildColorTheme} beyond the standard
 * {@link ContrastLevelName} values. `highest-contrast` always picks the palette color with the most
 * contrast against the fixed color; `lowest-contrast` always picks the closest.
 *
 * @category Color Theme
 */
export const ExtremeContrastLevel = {
    HighestContrast: 'highest-contrast',
    LowestContrast: 'lowest-contrast',
} as const;

/** @category Color Theme */
export type ExtremeContrastLevel = (typeof ExtremeContrastLevel)[keyof typeof ExtremeContrastLevel];
